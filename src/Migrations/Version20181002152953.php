 ...
 */
final class Version20181002152953 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Formation CHANGE display_pour_user display_pour_user VARCHAR(255) NOT NULL COLLATE utf8_general_ci, CHANGE isvalide isvalide TINYINT(1) NOT NULL');
    }
}
